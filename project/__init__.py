...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:Jonny25250509@127.0.0.1:3307/flasksecurity'
    ...
    #Registramos el blueprint para los productos
    from .products import productos as products_blueprint
